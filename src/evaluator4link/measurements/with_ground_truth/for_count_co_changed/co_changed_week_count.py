...
class CoChangedWeekCountMeasurement(StrategyWithGroundTruthMeasurement):
    ...
    @property
    def __select_co_changed_weeks_sql_stmt(self) -> str: return '''
    ...
    @property
    def __select_co_changed_tested_with_weeks_sql_stmt(self) -> str: return '''
        UNFINISHED
    '''
    ...
    @property
    def commits_ground_truth(self) -> Dict[int, int]: pass

    @property
    def commit_predicted_co_changed_for_test(self) -> Dict[int, int]: pass

    @property
    def commit_predicted_co_changed_for_tested(self) -> Dict[int, int]: pass


    def __init__(self, path_to_db: str, path_to_csv: str): pass

    def _measure(self) -> None: pass

    def __get_co_changed_commits_for(self, test_id: int, tested_id: int) -> List[int]: pass

    def __get_predicted_co_changed_commits_for(self, sql_stmt: str, parameters: Dict[str, int]) -> List[int]:pass

    def __from_commits_to_x(self, hash_value: str) -> int: pass
