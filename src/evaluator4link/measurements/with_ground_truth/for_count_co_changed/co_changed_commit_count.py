...
class CoChangedCommitCountMeasurement(StrategyWithGroundTruthMeasurement):
    ...
    def _measure(self) -> None:
        ...
        for test_id in test_id_set:
            ...
            for commit in self.__get_predicted_co_changed_commits_for(sql_stmt, {'test_method_id' : test_id}):
        ...
        for tested_id in tested_id_set:
            ...
            for commit in self.__get_predicted_co_changed_commits_for(sql_stmt, {'tested_method_id' : tested_id}):
    ...
    def __get_co_changed_commits_for(self, test_id: int, tested_id: int) -> List[int]:
        ...
        exe_res = cursor.execute(self.__select_co_changed_commits_sql_stmt, {
    ...
    def __get_predicted_co_changed_commits_for(self, sql_stmt: str, parameters: Dict[str, int]) -> List[int]:
        cursor = self._predict_database.cursor()
