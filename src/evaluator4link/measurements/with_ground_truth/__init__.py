...
from evaluator4link.measurements.with_ground_truth.meta_data_measurement \
    import StrategyWithGroundTruthMeasurement
...
from evaluator4link.measurements.with_ground_truth.for_count_co_changed \
    import CoChangedCommitCountMeasurement