...
class AbsLinkEstablisher(object):
    ...
    @property
    @abc.abstractmethod
    def _remove_previous_table_sql(self) -> str: pass

    @property
    @abc.abstractmethod
    def _initial_table_sql(self) -> str: pass

    @property
    @abc.abstractmethod
    def _insert_new_row_sql(self) -> str: pass

    @property
    @abc.abstractmethod
    def _link_establishing_sql(self) -> str: pass